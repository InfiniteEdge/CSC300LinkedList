                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getTitle().equals("DELETE")) {
                            ...
                            ListCore.ll.addAtIndex(ListCore.userInput.getText().toString(), ListCore.ll.indexOf(myself));
                            ListCore.ll.display();
                        } else if (item.getTitle().equals("ADD BELOW")) {
                            ListCore.ll.addAtIndex(ListCore.userInput.getText().toString(), ListCore.ll.indexOf(myself)+1);
                            ListCore.ll.display();
                        }
                        return true;
